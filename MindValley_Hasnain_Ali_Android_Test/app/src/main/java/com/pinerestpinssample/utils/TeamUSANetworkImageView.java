...
public class TeamUSANetworkImageView extends ImageView {
	...
	public TeamUSANetworkImageView(Context context) {
		this(context, null);
	}

	public TeamUSANetworkImageView(Context context, AttributeSet attrs) {
